  ...
  describe('tasks is Iterable', () => {
    ...
    describe('resolve', () => {
      it('returns Promise<T>', async () => {
        const value1 = 'value1'
        const value2 = 'value2'
        const task1 = vi.fn().mockReturnValue(Promise.resolve(value1))
        const task2 = vi.fn().mockReturnValue(Promise.resolve(value2))
    ...
    describe('reject', () => {
      it('returns rejected Promise', async () => {
        ...
        const value = 'value'
        const task1 = vi.fn().mockReturnValue(Promise.reject(error))
        const task2 = vi.fn().mockReturnValue(Promise.resolve(value))
